...
def split_date_feature(df: pd.DataFrame, date_column: str = 'Date') -> pd.DataFrame:
    """
    ...
    if date_column not in df.columns:
        print(f'⚠️ Warning: {date_column} not found')
        return df
    ...
    df['WeekOfTheYear'] = df[date_column].dt.isocalendar().week
